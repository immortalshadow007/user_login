...
class UserLoginView(APIView):
    """
    View to create a user login entry in the database.
    """
    ...
    def post(self, request, *args, **kwargs):
        ...
        user_exists = MobileNumber.check_user_profile_exists(mobile_number)
    ...
    def trigger_otp_management(self, encrypted_mobile_number, document_id):
        ...
        try:
            ...
            api_url = os.getenv("OTP_MAMAGEMENT_API_URL")
            api_key = os.getenv("OTP_MAMAGEMENT_API_KEY")
